...
export default function About({ onSelectProject, onViewCompany }: Props) {
  return (
                        ...
                        <div className="flex flex-col gap-1.5">
                          {displayProjects.map((proj) => (
                            <button
                              ...
                              className="flex items-center gap-3 py-2 px-3 bg-[#0d0d1a] border border-[rgba(255,255,255,0.07)] rounded-sm text-left w-full hover:border-[rgba(255,255,255,0.2)] transition-colors"
                            >
                              <div
                          ...
                          {remaining > 0 && (
                            <button
                              type="button"
                              onClick={() => {
                                onViewCompany(exp.company);
                                document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' });
                              }}
                              className="flex items-center gap-2 py-2 px-3 text-[11px] font-mono text-[#6a6a88] hover:text-[#00d4ff] transition-colors text-left"
                              style={{ fontFamily: 'var(--font-mono)' }}
                            >
